...
import 'package:chat_app/contact_details_view.dart';
...
class HomeView extends StatelessWidget {
  ...
  final List<Map<String, String>> data = [
    ...
    {
      "name": "Cinderella Harper",
      "phone": "1-238-113-6033",
      "email": "proin.nisl@icloud.org",
      "country": "German Federation",
      "region": "Guanacaste"
    },
    {
        ...
        actions: const [
          Padding(
            ...
            child: Center(
              child: CircleAvatar(
                radius: 25,
                backgroundImage: AssetImage('images/memoji3.png'),
              ),
            ),
          )
        ],
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    leading: const CircleAvatar(
                      radius: 25,
                      backgroundImage: AssetImage('images/memoji4.png'),
                    ),
                    title: const Text(
                      'Alberto Calos',
                      style:
                ...
                return Column(
                  children: [
                    ListTile(
                      ...
                      leading: const CircleAvatar(
                        radius: 25,
                        backgroundImage: AssetImage('images/memoji1.png'),
                      ),
                      title: Text(
                        '${element['name']}',
                        style: const TextStyle(
